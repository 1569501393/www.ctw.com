...
<div class="middle">
    <div class="uc clearfix account">
    	<div class="login">
	        <?php if($seo["sina_app_key"] && $seo.qq_app_key): ?><p class="login_title">登录</p>
	            <p class="mt20 f14"><strong>1.使用这些帐号登录：</strong></p>
	            <div class="login_list clearfix">
	                <?php if(($seo["sina_app_key"]) != ""): ?><a href="<?php echo u('uc/sina_login');?>" class="sina" target="_blank"></a><?php endif; ?>
	                <?php if(($seo["qq_app_key"]) != ""): ?><a href="<?php echo u('uc/qq_login');?>" class="qq" target="_blank"></a><?php endif; ?>
	            </div><?php endif; ?>
            ...
            <form id="myform" name="myform" action="" method="post" onsubmit="return check();">
                <table class="mt10">
                    ...
                    <tr>
					 ...
					 <tr>
                            ...
                            <td>
                            	...
                            	<img src="<?php echo u('public/verify');?>" class="verify_img" class="left"                              
					...
					<tr>
                        <th></th>
                        <td>还没有账号：<a style="color: #123DB4;" href="<?php echo u('uc/register');?>">立即注册</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;忘记密码：<a style="color: #123DB4;" href="<?php echo u('uc/find_password');?>">找回密码</a></td>                    
                    </tr>                 
                </table>            
            </form>
        </div>		
