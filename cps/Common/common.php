 ...
 * */
function cashback($commission, $cashback_rate, $integralback_rate)
{  //输入会员等级，订单总佣金，输出该会员应该得到的返现，等级不输入，按最低返现计算
    $cashback = array();
...
function cashback_jifenbao($commission, $fanxian_bili, $cashback_rate, $integralback_rate)
{  //输入会员等级，订单总佣金，输出该会员应该得到的返现，等级不输入，按最低返现计算
    $cashback = array();
