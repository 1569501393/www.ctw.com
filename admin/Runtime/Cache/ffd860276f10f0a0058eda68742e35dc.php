	...
	$('tr',table_form).each(function(){ 
		...
		td_2_input.click(function(){ 
			td_1_input.attr('checked',is_all_checked(td_2_input));			  
              		...
              		</td></tr><?php endforeach; endif; ?></table><div class="bk15"></div><input type="hidden" name="id" value="<?php echo ($id); ?>" /><div class="btn"><input type="submit" value="<?php echo (L("submit")); ?>" name="dosubmit" class="button" id="dosubmit"/></div></form></div></body></html>