...
</script><title><?php echo (L("website_manage")); ?></title></head><body><div id="ajax_loading">提交请求中，请稍候...</div><?php if($show_header != false): if(($sub_menu != '') OR ($big_menu != '')): ?><div class="subnav"><div class="content-menu ib-a blue line-x"><?php if(!empty($big_menu)): ?><a class="add fb" href="<?php echo ($big_menu["0"]); ?>"><em><?php echo ($big_menu["1"]); ?></em></a>　<?php endif; ?></div></div><?php endif; endif; ?><style type="text/css"><!--
.content{ padding:46px 12px 10px 25px; font-size:14px; height:64px; text-align:left}
.ok,.guery{background: url(__ROOT__/statics/admin/images/ajax_loading.gif) no-repeat 0px 47px ;}
--></style><?php if(isset($jump_url)): ?><meta http-equiv="refresh" content="1;url=<?php echo ($jump_url); ?>" /><?php endif; ?></present><div style="text-align:center"><div class="content ok" style="display:inline-block;display:-moz-inline-stack;zoom:1;*display:inline;max-width:330px;"><?php echo ($message); ?></div></present><?php if(isset($dialog)): ?><script style="text/javascript">	var dialog = "<?php echo ($dialog); ?>";
