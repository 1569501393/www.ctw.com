...
<html>
    <head>
        ...
        <link href="./assets/plugins/dropzone/dist/dropzone.css" rel="stylesheet" type="text/css" /><!-- 上传 -->
        <link href="./assets/plugins/sweetalert/dist/sweetalert.css" rel="stylesheet" type="text/css"><!-- 弹窗提示 -->
        <link href="./assets/plugins/morris/morris.css" rel="stylesheet"><!-- 统计 -->
...
<!-- <body class="fixed-left" identity="<?php echo($identity); ?>"> -->
