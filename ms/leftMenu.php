    ...
    <div class="sidebar-inner slimscrollleft">
        ...
        <div id="sidebar-menu">
            <ul>
                ...
                <li class="">
                    <a href="announcements.php" class="waves-effect left-menu" page="announcements"><i class="ti-announcement"></i><span> 联盟公告</span></a>
                ...
                <li class="">
                    <a href="posters.php" class="waves-effect left-menu" page="posters"><i class="ti-image"></i><span> 海报管理</span></a>
                </li>
