...
function loadSingle(type){
    ...
    if (type=='goodslist') {
	    var content = "<div class='singlegoods'><a href='#'><div class='thumbs'><img class='wid' src='./assets/images/unknown.jpeg'></div></a><div class='goodsinfo'><span class='goodstitle'>华为 （HUAWEI） nova 4GB+64GB 全</span><span class='goodsdetials'>商品佣金范围:<span>20-100 </span></span><span class='goodsdetials'>佣金比例范围:<span>5%-10% </span></span><button type='button' class='btn btn-default btn-rounded waves-effect waves-light'>立即推广</button></div></div>";
    }else if(type=='shopslist'){
    	var content = "<div class='singleshop'><a href='#'><div class='thumbs'><img class='wid' src='./assets/images/unknown.jpeg'></div></a><div class='goodsinfo'><span class='goodstitle'>华为 （HUAWEI） nova 4GB+64GB 全金属机身、超级好用</span><span class='goodsdetials'>价格:<span class='num'>100 </span></span><span class='goodsdetials importantinfo'>佣金:<span class='num'>30</span> <span class='linespace'></span>佣金比例:<span class='num'>30%</span></span></div><div class='bottomfunc'><button type='button' class='btn btn-default btn-rounded waves-effect waves-light' onclick='promote(this);' promoteid='goodsid'>立即推广</button></div></div>";
    }
